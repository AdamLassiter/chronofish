...
The general gameplay of 5D Chess with Multiverse Time Travel starts off similarly to a standard game of chess.
As the game progresses, the game becomes increasingly complex through a series of alternate timelines that the player can take advantage of.
The game can be played online against other players or offline against an AI or another player sitting at the same computer.

## Rules

See also: Rules of chess
...
* The x-axis from standard chess, which is notated using the letters a through h for the eight files.
...
* The king may move one space along any number of axes. Castling is permitted but not generalized across turns and timelines, nor is the prohibition of castling out of or through check.[a]
